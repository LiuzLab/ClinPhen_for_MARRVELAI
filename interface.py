...
smallLabels = ["Description", "haveUMLS", "CustomThesaurusInstructions", "hpoDescription", "umlsDescription", "customDescription", "recordFileDescription", "recordTextDescription", "copyDescription", "saveDescription", "allLabel", "fourLabel", "excelDescription", "tabLabel", "commaLabel", "limitLabel", "formatLabel", "idListLabel"]
#messages = ["Results"]
messages = []
...
def saveResults(button):
  saveLoc = ClinPhen.saveBox(title="Save")
  global results
  saveResults = results
...
ClinPhen.setGeometry("fullscreen")
windowWidth = ClinPhen.topLevel.winfo_width()
...
ClinPhen.addButton("Credits", (lambda button: ClinPhen.infoBox("Credits", "Copyright 2018 Cole Deisseroth, Johannes Birgmeier, Jon Bernstein, and Gill Bejerano.\nSoftware uses appJar, provided by Richard Jarvis.\nSpecial thanks to Ethan E. Bodle, Elijah Kravets, and the Bejerano Lab for helping us improve the software.")), i-1, 0)
...
ClinPhen.addWebLink("For more information, see the manuscript.", "https://www.google.com/", ipp(), 0, 3)
